...
## Table of Contents
* [General Info](Build a model to predict the bike rent value using Linear Regression Technique)
* [Technologies Used](#Numpy,Pandas,Seaborn,StatsModel and Scikit )
